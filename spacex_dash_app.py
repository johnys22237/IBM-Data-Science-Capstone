...
RangeMarks = {0:'0', 2500:'2500', 5000:'5000', 7500:'7500', 10000:'10000'}
...
# funcao pro if else statement
def get_scatter_chart(entered_site,entered_kg):
    print(entered_kg)
    low, high = entered_kg
    filtered_df = spacex_df.loc[(spacex_df['Launch Site'] == entered_site)]
    ...
    if entered_site == 'ALL':
        ...
        # return the outcomes piechart for a selected site
        fig = px.scatter(filtered_df[mask2],x="Payload Mass (kg)", y="class", color="Booster Version Category")
        #fig.update_layout(title='Correlation between Payload and Success for all Sites', xaxis_title='Payload Mass (kg)', yaxis_title='Class')
        return fig
